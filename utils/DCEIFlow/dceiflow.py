...
from DCEIFlow.decoder.with_event_updater import BasicUpdateBlockNoMask, SmallUpdateBlock
from DCEIFlow.backbone.raft_encoder import BasicEncoder, SmallEncoder
from DCEIFlow.corr.raft_corr import CorrBlock, AlternateCorrBlock
...
class DCEIFlow(nn.Module):
    def __init__(self, args):
        ...
        self.isbi = args.isbi
        self.event_bins = 2 * args.event_bins
